...
public:
  ...
  */
  ...
  /*!
     \brief Set the order K of the NURBS function of the dimension X
     \param K
  */
  ...
  /*!
  \brief Set the order K of the NURBS function of the dimension Y
  \param K
  */
  void setOrderKY(int k);

  /*!
  \brief Get the order K of the NURBS function of the dimension X
  \return K
  */
  int getOrderKX() const ;

  /*!
  \brief Get the order K of the NURBS function of the dimension Y
  \return K
  */
  int getOrderKY() const ;

  /*!
  \brief Get the N of the NURBS function of the dimension X (N+1 is number of control points )
  \return N
  */
  int getNX() const ;

  /*!
  \brief Get the N of the NURBS function of the dimension Y (N+1 is number of control points )
  \return N
  */
  int getNY() const ;
...
private:
  ...
  */
  ...
  // modalVector, orders ans the n are only used to calcul nurbs so it's own to this class
